...
In the previous data sets we looked at, there were no missing data. Let's load a file with some missing data. Download <a href="https://raw.githubusercontent.com/seannyD/IntroToRForTheLanguageSciences/master/data/WALS_ObjectVerbOrder.csv" download>this file (WALS_ObjectVerbOrder.csv)</a> into your **data** folder.

This file *WALS_ObjectVerbOrder.csv* contains missing values. Create a new script called "part5.R". Now load the data, like before:
