...
-  If statements to run some code only if a certain condition holds.
-  For loops to run some code several times for each item in a vector.
-  Lists, which are sequences of vectors, where each vector can have a different length.
